...
import { RichTextToolbarButtonObject, RichTextToolbarButtonComponentProps } from '../button.d';
...
const ColorPicker = (props: RichTextToolbarButtonComponentProps) => {
  ...
  return (
    <React.Fragment>
      <span
        className={'rich-text-color-picker-button' + (isOpen ? ' active' : '')}
        onClick={e => {
          setIsOpen(!isOpen);
        }}
      >
      ...
      <div className="rich-text-color-picker" ref={pickerRef} style={{ display: isOpen ? 'block' : 'none' }}>
