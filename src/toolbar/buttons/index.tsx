...
const createIconComp = (icon: IconDefinition) => {
...
const buttons: { [k: string]: RichTextToolbarButtonObject } = {
  ...
  STRIKETHROUGH: createButton('INLINE', createIconComp(faStrikethrough), 'STRIKETHROUGH'),
  BLOCKQUOTE: createButton('BLOCK', createIconComp(faQuoteLeft), 'blockquote'),
